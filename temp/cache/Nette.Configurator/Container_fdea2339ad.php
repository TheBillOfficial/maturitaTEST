<?php
// source: C:\Users\NTB-HOME\Documents\sandbox\app/config/config.neon 
// source: C:\Users\NTB-HOME\Documents\sandbox\app/config/config.local.neon 

class Container_fdea2339ad extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\BasePresenter' => [1 => ['application.1', 'application.3', 'application.4', 'application.5']],
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\Users\NTB-HOME\Documents\sandbox\app',
			'wwwDir' => 'C:\Users\NTB-HOME\Documents\sandbox\www',
			'debugMode' => false,
			'productionMode' => true,
			'consoleMode' => true,
			'tempDir' => 'C:\Users\NTB-HOME\Documents\sandbox\app/../temp',
		];
	}
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\Users\NTB-HOME\Documents\sandbox\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Users\NTB-HOME\Documents\sandbox\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_fdea2339ad $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\Users\NTB-HOME\Documents\sandbox\app/../temp/cache/latte');
